...
bool Anagram::WordPairIsAnagram(const std::string& word1, const std::string& word2) {
    ...
    word1Copy.erase(remove_if(word1Copy.begin(), word1Copy.end(), !isalpha), word1Copy.end());
    word2Copy.erase(remove_if(word2Copy.begin(), word2Copy.end(), !isalpha), word2Copy.end());
